                ...
                <div class="col-lg-8 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                                ...
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="text" id="sh_review" class="form-control" name="sh_review">
                            ...
                            <div class="form-group">
                                <input type="checkbox" id="featured" class="filled-in" name="featured" value="1">
                ...
                <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            ...
                            <div class="form-group form-float">
                                <div class="form-line">
                                    <input type="text" id="developer" class="form-control" name="developer">
